...
SECRET_KEY = '*_=@a(9#i)ux=hamhieq=qqmp39jkis_=n^!5g9#wql^83v$mu'
...
TEMPLATES = [
    {
        ...
        'DIRS': [  os.path.join(BASE_DIR, 'template'), os.path.join(BASE_DIR, 'blog/template'), os.path.join(BASE_DIR, 'searches/template')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
